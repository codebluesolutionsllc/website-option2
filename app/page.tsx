...
const BASE_PATH = "/website-option2"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        style={{
          backgroundImage: `url('${BASE_PATH}/travel-hero-image.png')`,
        }}
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center py-4">
              <div className="flex items-center space-x-3 mb-4">
                <img src={`${BASE_PATH}/mursing-logo-new.png`} alt="Mursing Travels" className="h-36 w-auto" />
              </div>
              <nav className="hidden md:flex space-x-8">
                <a href={`${BASE_PATH}#home`} className="hover:text-accent transition-colors">Home</a>
                <a href={`${BASE_PATH}#why-advisor`} className="hover:text-accent transition-colors">Why Use an Advisor</a>
                <a href={`${BASE_PATH}#destinations`} className="hover:text-accent transition-colors">Destinations</a>
                <a href={`${BASE_PATH}#consultation`} className="hover:text-accent transition-colors">Book Consultation</a>
                <a href={`${BASE_PATH}#connect`} className="hover:text-accent transition-colors">Connect</a>
              </nav>
            </div>
          </div>
        </header>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="overflow-hidden group cursor-pointer hover:shadow-lg transition-shadow">
              <div className="relative h-48 bg-gradient-to-br from-blue-400 to-teal-500">
                <img
                  src={`${BASE_PATH}/grand-cayman-crystal-clear-turquoise-waters-white-.png`}
                  alt="Grand Cayman"
            ...
            <Card className="overflow-hidden group cursor-pointer hover:shadow-lg transition-shadow">
              <div className="relative h-48 bg-gradient-to-br from-orange-400 to-red-500">
                <img
                  src={`${BASE_PATH}/tokyo-japan-cherry-blossoms-modern-city-skyline.png`}
                  alt="Tokyo, Japan"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors"></div>
